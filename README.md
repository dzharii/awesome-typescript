...
- [Cloud Native Data Infrastructure](#cloud-native-data-infrastructure)
...
- [CNDI](https://github.com/polyseam/cndi) CNDI is perfect for deploying data services consistently that are reliable, discoverable, maintainable, and interoperable, all while remaining flexible to the needs of each stack.
