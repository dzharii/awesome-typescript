...
- [Awesome TypeScript](#awesome-typescript)
      - [-= Awesome TypeScript =- Awesome Elasticsearch →](#--awesome-typescript---awesome-elasticsearch-)
  - [More awesome resources](#more-awesome-resources)
  ...
  - [Getting Started with (Awesome) TypeScript](#getting-started-with-awesome-typescript)
    ...
    - [IDE](#ide)
      - [Offline](#offline)
        ...
        - [Other (Plugins || Cross-platform || OSS || Free)](#other-plugins--cross-platform--oss--free)
      - [Online](#online)
...
- [Video Courses](#video-courses)
  - [:free: Free Courses](#free-free-courses)
  - [:dollar: Paid Courses](#dollar-paid-courses)
- [Tutorials](#tutorials)
- [Roadmap](#roadmap)
  - [Badges](#badges)
  - [Social](#social)
